...
def tell_weather() :
    ...
    if x["cod"] != "404" :
        ...
        current_temperature = ( x['main']['temp']-273.16)
 
        # store the value corresponding to the "pressure" key 
        current_pressure =  x['main']['pressure']
 
        # store the value corresponding to the "humidity" key 
        ...
        temp_field.insert(15, str('%0.2f'%current_temperature) + "C")
...
if __name__ == "__main__" :
    ...
    root.configure(background = '#293241')
 
    # Set the configuration of GUI window
    root.geometry("600x300+300+300")
    root.resizable('true','true')
    # Create a Weather Gui Application label
    headlabel = Label(root, text = "Weather Gui Application",fg = 'white', bg = 'red',font={'bold', 30})
     
    # Create a City name : label
    label1 = Label(root, text = "City name : ", fg = 'black',font={'bold', 20})
     
    # Create a City name : label
    label2 = Label(root, text = "Temperature :",fg = 'black',font={'bold', 20})
 
    # Create a atm pressure : label
    label3 = Label(root, text = "atm pressure :",fg = 'black',font={'bold', 20})
 
    # Create a humidity : label
    label4 = Label(root, text = "humidity :",fg = 'black',font={'bold', 20})
 
    # Create a description :label
    label5 = Label(root, text = "description  :",fg = 'black',font={'bold', 20})
